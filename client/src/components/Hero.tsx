...
export default function Hero() {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center pt-20 pb-10 relative overflow-hidden bg-gradient-to-br from-background via-background to-secondary/30 dark:from-background dark:via-background dark:to-primary/5 transition-colors duration-500"
    >
      ...
      <div className="container-width grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          >
            <span className="w-8 h-[2px] bg-primary/60 inline-block"></span>{" "}
            Hello!
          </motion.div>
        ...
        >
          ...
          <div className="flex items-center md:justify-start justify-center gap-6">
            ...
            <a
              href="mailto:duanehorton.jobstar@gmail.com"
              className="text-muted-foreground hover:text-primary transition-colors hover:-translate-y-1 transform duration-200"
            >
